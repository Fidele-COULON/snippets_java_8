...
// http://localhost:8080/POC_JAAS_TOMCAT_JSP/HelloWorld?redirect=1
// http://localhost:8080/POC_JAAS_TOMCAT_JSP/HelloWorld?forward=1[?redirect=1|?forward=1]
public class HelloWorld extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("<br/>AuthType : " + request.getAuthType()); // BASIC ou DIGEST ou FORM
